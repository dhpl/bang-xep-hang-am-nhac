...
public class FragmentHan extends Fragment implements AsyncRespone{

    private static final String NHAC_HAN = "http://chiasenhac.vn/mp3/korea/";

    public HienThiDanhSachBaiHat2 mHienThiDanhSachBaiHat;

    private RecyclerView mRecyclerViewNhacHan;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mHienThiDanhSachBaiHat.execute(NHAC_HAN);
        mBaiHats = new ArrayList<>();
        mRecyclerViewNhacHan = (RecyclerView) view.findViewById(R.id.recyclerViewHan);

        mRecyclerViewNhacHan.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        mRecyclerViewNhacHan.setHasFixedSize(true);
        mRecyclerViewNhacHan.setNestedScrollingEnabled(false);
        mRecyclerViewNhacHan.setItemAnimator(new DefaultItemAnimator());
        return view;
    }
    ...
    public void processFinish(List<BaiHat> output) {
        ...
        mRecyclerViewNhacHan.setAdapter(mBaiHatAdapter);
